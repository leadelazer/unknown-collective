...
export const CHARACTERS = [
  {
    ...
    detail: true,
    bio: bios["florist"],
    talisman: "The Florist Talisman infuses its holder with an unquenchable zest for life and a fierce courage to step into the unknown. It represents the joy of new beginnings, the thrill of discovery, and an insatiable curiosity. The Florist encourages spontaneity, creativity, and a leap of faith into the unpredictable dance of life. When the holder embraces it, they embody the spirit of fearlessly exploring the unknown — much like a seed breaking through its shell to grow towards the sun.",
    shadow: "When the Florist card falls into its Shadow form, it reveals a cautionary tale of impulsiveness and recklessness. The boundless curiosity and adventurous spirit can lead to rushed decisions, a lack of foresight, and a disregard for consequences. Just as a flower can wilt without proper care, so can the Florist's joyful exploration turn into a thoughtless pursuit of fleeting pleasures. The shadow invites reflection on direction: adventure without grounding is drift.",
    relations: [
          "curator",
          "gardener",
          "weavers"
    ...
    stories: [
          {
                ...
                "caption": "Annotated in three hands."
          },
          {
                "src": "/assets/botanics/lavender.png",
                "title": "Lavender, IX",
                "caption": "Devotion. Silence. Distrust."
          },
          {
                "src": "/assets/botanics/michaelmas-daisy.png",
                "title": "Michaelmas daisy",
                "caption": "A farewell kept polite."
          }
    ],
    ...
    stories: [
          {
                ...
                "title": "Two scholars",
                "caption": "Garden of the old library, undated."
          },
          {
                "src": "/assets/stories/lakeside.png",
                "title": "Lakeside correspondence",
                "caption": "The Curator writes only in indigo."
          },
          {
                "src": "/assets/echos/mapmaker.png",
                "title": "The Mapmaker",
                "caption": "A frequent visitor; leaves nothing behind."
          }
    ],
  ...
  },
  {
    ...
    role: "The Oracle",
    name: "Greta Frederike von Waldeck",
    tier: "luminaries",
    slug: "oracle",
    ...
    stories: [
          ...
          },
          {
                ...
                "title": "The Lohengrin",
                "caption": "A quiet hour before the performance."
          }
    ],
  ...
  },
  {
    ...
    arcana: "The Lovers",
    role: "The Weavers",
    name: "Heinrich and Matilda Weber",
    tier: "grounded",
    slug: "weavers",
  ...
  },
  {
    n: 11,
    arcana: "Justice",
    role: "The Obsidian Count",
    name: "Leopold von Hohenberg",
    tier: "luminaries",
    slug: "obsidian-count",
  ...
  },
  {
    n: 15,
    arcana: "The Devil",
    role: "The Mirrormaker",
    name: "Valentin Klarblick",
    tier: "custodians",
    slug: "mirrormaker",
